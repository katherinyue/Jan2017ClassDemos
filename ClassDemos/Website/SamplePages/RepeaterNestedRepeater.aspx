...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <br /><br />
    <div class="col-sm-6">
    <!-- inside a repeater you need as a minimum an ItemTemplate other templates include HeaderTemplate,
         footerTemplate,AlternatingItemTemplate
    ...
    <asp:Repeater ID="ArtistAlbumReleasesList" runat="server" DataSourceID="ArtistAlbumReleasesODS">
        <HeaderTemplate>
            <h4>Albums Releases for Artists</h4>
        </HeaderTemplate>
        <ItemTemplate>
    ...
    <!-- inside a repeater you need as a minimum an ItemTemplate other templates include HeaderTemplate,
        ...
        use of the ItemType parameter on the repeater allows you to use object instance referencing (instance.property) 
    ...
    <asp:Repeater ID="ArtistAlbumReleasesB" runat="server" DataSourceID="ArtistAlbumReleasesODS"
        ...
        <ItemTemplate>
            ...
            <asp:Repeater ID="AlbumsB" runat="server" DataSource='<%# Item.Albums%>'
                ItemType="Chinook.Data.POCOs.AlbumReleases">
                <HeaderTemplate>
                    <table>
                        <tr>
                            <th>Year</th>
    ...
    <asp:ObjectDataSource ID="ArtistAlbumReleasesODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ArtistAlbumReleases_List" TypeName="ChinookSystem.BLL.AlbumController">
